                ...
                .addGroup(groupLayout.createSequentialGroup()
                    ...
                    .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                                ...
                                .addGroup(groupLayout.createSequentialGroup()
                                    ...
                                    .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                                        ...
                                        .addComponent(lblDataFinal, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
                                    .addGap(5)
                                    .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                                    ...
                                    .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
                                        ...
                                        .addComponent(lblSangue, GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)))
                                .addGroup(groupLayout.createSequentialGroup()
                        ...
                        .addGroup(groupLayout.createSequentialGroup()
                            ...
                            .addGap(5)
                            .addComponent(lblComplemento, GroupLayout.PREFERRED_SIZE, 405, GroupLayout.PREFERRED_SIZE)
                            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(groupLayout.createSequentialGroup()
                            .addComponent(mAddress, GroupLayout.PREFERRED_SIZE, 700, GroupLayout.PREFERRED_SIZE)
                            .addGap(5)
                            .addComponent(mAddressMore, GroupLayout.PREFERRED_SIZE, 405, GroupLayout.PREFERRED_SIZE)
                            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(groupLayout.createSequentialGroup()
                            .addComponent(lblBairro, GroupLayout.PREFERRED_SIZE, 530, GroupLayout.PREFERRED_SIZE)
                            .addGap(5)
                            ...
                            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(groupLayout.createSequentialGroup()
                            .addComponent(mDistrict, GroupLayout.PREFERRED_SIZE, 530, GroupLayout.PREFERRED_SIZE)
                            .addGap(5)
                        ...
                        .addGroup(groupLayout.createSequentialGroup()
                            .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
                                .addGroup(groupLayout.createSequentialGroup()
                                    ...
                                    .addGap(5)
                                    .addComponent(lblGraduao, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
                                    .addComponent(mIsLeader, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
                                    .addGap(5)
                                    .addComponent(mLevel, GroupLayout.PREFERRED_SIZE, 320, GroupLayout.PREFERRED_SIZE)))
